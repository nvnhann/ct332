...
{ 
	...
	// Neu khong con cho trong de choi tiep và khong ben nao thang
	// thi 2 ben hue nhau
...
{ 
	...
	printf("Gia tri cua nuoc co tot nhat la : %d\n\n", bestVal); 
	return bestMove;
} 
...
{ 
	...
	printf("Nuoc di tot nhat la :\n"); 
	printf("%d %d", bestMove.row,  bestMove.col);
	return 0; 
} 
